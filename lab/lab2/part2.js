...
console.log(largeStationList = _.filter(data, function(array){return array[3] > 20}));


var largeStationCount;
console.log(largeStationCount= _.countBy(data, function(array){return array[3] > 20}).true);
